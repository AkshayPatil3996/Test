...
export default function RegistrationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        console.log("User and tenant created successfully", response.data);
  ...
  return (
    <div className="w-full min-h-screen grid grid-cols-12 gap-0">
      {/* Image Section */}
      <div className="col-span-12 md:col-span-8 bg-[#437AA4] flex items-center">
        <img
